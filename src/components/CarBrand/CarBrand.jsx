...
const CarBrand = ({ car }) => {
  ...
  return (
    <div>
            <Link to={`/products/${id}`}>  <div className="card lg:card bg-base-100 shadow-xl transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-[#ee4747]/30" data-aos="flip-down">
